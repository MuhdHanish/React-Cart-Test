...
import emptyCartImage from "../../assets/cart-empty-img.png";
import "./Cart.css";
  ...
  return (
    <div className="cart-container">
      <div className="cart-heading">
        ...
        <span className="text-xl font-bold text-textColor">Shopping Cart</span>
      </div>
      <div className="cart-body">
        {products.length ? (
            ...
            <div className="cart-product" key={product?._id}>
              ...
              <div className="flex gap-5 items-center px-3">
                ...
                <button
                  ...
                  className="cart-button text-[12px]"
                >
                  x
                </button>
              </div>
          ...
          <div className="w-full flex justify-center items-baseline">
            <img className="w-1/2 h-1/2" src={emptyCartImage} alt="" />
          </div>
        )}
      </div>
    </div>
