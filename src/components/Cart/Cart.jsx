      ...
      <div className="w-full h-fit flex flex-col justify-start items-start gap-4">
        <div className="w-full sm:w-2/3  flex justify-between items-center border p-2 rounded-md">
            ...
            <div className="flex flex-col justify-center items-start gap-2">
              <div className="flex flex-col gap-1 justify-center items-start ">
                ...
                <span className="text-[11px] text-gray-500">
                  {Dumb[0].description.slice(0, 30) + "..."}
                </span>
              </div>
              <div className="flex w-full h-fit justify-start items-center text-[14px] gap-3">
                <button className="p-1 shadow-md rounded-full border w-6 h-6 flex justify-center items-center outline-none bg-gray-100">
                  +
                </button>
          ...
          <div className="flex gap-5 items-center px-5">
            ...
            <button className="p-1 shadow-md   rounded-full border w-6 h-6 flex justify-center items-center outline-none bg-gray-100 text-[12px]">
              x
            </button>
          </div>
        </div>
